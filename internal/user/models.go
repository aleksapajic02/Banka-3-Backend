...
func (Activity_codes) TableName() string {
...
func (Authorized_party) Table_name() string {
...
func (Loan_installment) TableName() string {
	return "loan_installment"
}

func (Loan_request) TableName() string {
	return "loan_request"
}
